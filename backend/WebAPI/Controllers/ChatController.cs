...
public class ChatController : ControllerBase
{
    ...
    private static object KeywordFallback(string message, string? conversationId = null)
    {
        ...
        var keywords = new Dictionary<string, (string name, string severity, string explanation, string fix)>
        {
            ...
            ["missing permissions-policy"] = ("Missing Security Headers", "Medium",
                "Missing Permissions-Policy means any iframe or script can request camera, microphone, geolocation, USB, payment, and other powerful APIs. The old name was Feature-Policy.",
            ...
            ["missing permissions policy"] = ("Missing Security Headers", "Medium",
                "Missing Permissions-Policy means any iframe or script can request camera, microphone, geolocation, and other powerful APIs.",
                "Send a restrictive Permissions-Policy header disabling unused APIs, e.g. 'camera=(), microphone=(), geolocation=()'."),
            ["missing cross-origin-opener-policy"] = ("Missing Security Headers", "Medium",
                "Missing Cross-Origin-Opener-Policy (COOP) leaves the browsing context group shared with cross-origin popups. Together with CORP/COEP it enables cross-origin isolation and defends against Spectre-class side-channel attacks.",
                "Send 'Cross-Origin-Opener-Policy: same-origin' on all responses to isolate your page's browsing context group."),
            ["missing cross origin opener policy"] = ("Missing Security Headers", "Medium",
                "Missing Cross-Origin-Opener-Policy leaves the browsing context group shared with cross-origin popups and disables cross-origin isolation.",
                "Send 'Cross-Origin-Opener-Policy: same-origin' on all responses."),
            ["coop"] = ("Missing Security Headers", "Medium",
                "Cross-Origin-Opener-Policy (COOP) isolates your page's browsing context group from cross-origin windows, a prerequisite for cross-origin isolation and Spectre mitigations.",
                "Send 'Cross-Origin-Opener-Policy: same-origin' on all responses."),
            ["missing cross-origin-embedder-policy"] = ("Missing Security Headers", "Medium",
                "Missing Cross-Origin-Embedder-Policy (COEP) blocks loading of cross-origin resources without explicit opt-in, enabling cross-origin isolation alongside COOP.",
            ...
            ["coep"] = ("Missing Security Headers", "Medium",
                "Cross-Origin-Embedder-Policy (COEP) blocks loading of cross-origin resources without explicit opt-in, enabling cross-origin isolation alongside COOP.",
                "Send 'Cross-Origin-Embedder-Policy: require-corp'. Pair with COOP: same-origin for full cross-origin isolation."),
            ["missing cross-origin-resource-policy"] = ("Missing Security Headers", "Medium",
                "Missing Cross-Origin-Resource-Policy (CORP) means your resources can be embedded/read by any other origin, defeating cross-origin protections.",
                "Send 'Cross-Origin-Resource-Policy: same-site' (or same-origin) on resource responses."),
            ["corp"] = ("Missing Security Headers", "Medium",
                "Cross-Origin-Resource-Policy (CORP) blocks other origins from embedding or reading your resources when set to same-site or same-origin.",
                "Send 'Cross-Origin-Resource-Policy: same-site' on resource responses."),
            ["feature policy"] = ("Missing Security Headers", "Medium",
            ...
            ["autocomplete"] = ("Sensitive Form Autocomplete", "Medium",
                "Browsers auto-fill fields based on autocomplete attributes. Allowing autocomplete on credit-card fields, or using 'on' instead of 'new-password' / 'current-password', can leak data to shared-device users or browser-profile sync.",
            ...
            ["sensitive autocomplete"] = ("Sensitive Form Autocomplete", "Medium",
                "Misconfigured autocomplete attributes on sensitive fields (passwords, credit cards) leak data via shared-device autofill or browser-profile sync.",
